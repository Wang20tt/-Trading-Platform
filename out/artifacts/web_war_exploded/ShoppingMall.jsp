...
//于客户机的每次请求，代理服务器必须想服务器验证缓存是否过时；
    ...
    <style type="text/css">
        html, body {
             ...
             .mui-content {
                         background: url(images/256.png) bottom center no-repeat #efeff4;
...
<div style="height: 100px;width: 600px">
          <p style="font-family: 宋体;font-size: 40px;position: absolute;left: 35%;color:palevioletred">欢迎光临橙子二手交易</p>
...
//        String s1,s2,s3,s4=null;
    ...
    <%
        ...
        yourname= (String) application.getAttribute("姓名");
...
while (ii<i){
    ...
    System.out.println(application.getAttribute("姓名"));
        ...
        <div class="show">
            ...
            <div class="introduce" >
                卖家:  <input type="text"  name="username" value="<%=s1[ii]%> " style="border:none;background-color: white;color:black ;
font-size: 15px;font-family: 宋体;outline: none" readonly>
                <input type="hidden"  name="yourname" value="<%=yourname%>" style="border:none;background-color: white;color:black ;
font-size: 15px;font-family: 宋体;outline: none" readonly>
            </div>

                <div class="store" onclick="">
                    物品名称:<input type="submit" name="goodsname" value="<%=s3[ii]%>" style="border:none;background-color: white;color: #8236E5;
font-size: 15px;font-family: 宋体;outline: none">
                </div>
            </form>
